...
/* 引入请求loading */
import { showFullScreenLoading, tryHideFullScreenLoading } from '../config/serviceLoading.js'
/* 引入store */
...
const config = {
  /* 接口域名路径 */
  baseURL: 'https://mock.mengxuegu.com/mock/66e549da90f5322f879d823e' || import.meta.env.VITE_API_URL2,
  /* 超时时间 */
  timeout: 10000,
  /* 跨域时允许携带凭证 */
